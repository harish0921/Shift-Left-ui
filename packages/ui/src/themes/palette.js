...
export default function themePalette(theme) {
    return {
        ...
        background: {
            ...
            surfaceElevated: theme.customization.isDarkMode ? theme.colors?.darkLevel1 : theme.colors?.grey50
        },
        textBackground: {
        ...
        card: {
            main: theme.customization.isDarkMode ? theme.colors?.darkLevel1 : theme.colors?.paper,
            light: theme.customization.isDarkMode ? theme.colors?.darkPrimaryLight : theme.colors?.grey50,
            hover: theme.customization.isDarkMode ? theme.colors?.darkPrimary800 : theme.colors?.grey100
        },
        asyncSelect: {
            main: theme.customization.isDarkMode ? theme.colors?.darkPrimary800 : theme.colors?.grey50
        },
