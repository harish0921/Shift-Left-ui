...
import { streamStorageFile } from 'shiftleftai-components'
...
const getFileFromAssistant = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        if (!fileStream) throw new internalShiftLiftError(StatusCodes.INTERNAL_SERVER_ERROR, `Error: getFileFromAssistant`)
