    ...
    public async delete(req: Request, res: Response, next: NextFunction) {
        ...
        try {
            ...
            if (!query.organizationId) {
                throw new internalShiftLiftError(StatusCodes.BAD_REQUEST, 'Organization ID is required')
            }
            if (!query.userId) {
                throw new internalShiftLiftError(StatusCodes.BAD_REQUEST, 'User ID is required')
            }
