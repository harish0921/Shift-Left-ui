...
export class LoginMethodController {
    ...
    private assertEnterprisePlatform(): void {
        ...
        if (platformType === Platform.CLOUD || platformType === Platform.OPEN_SOURCE) {
            throw new internalShiftLiftError(StatusCodes.FORBIDDEN, GeneralErrorMessage.FORBIDDEN)
        }
    }
    ...
    public async read(req: Request, res: Response, next: NextFunction) {
        ...
        try {
            ...
            if (query.id) {
                ...
                if (!loginMethod) throw new internalShiftLiftError(StatusCodes.NOT_FOUND, LoginMethodErrorMessage.LOGIN_METHOD_NOT_FOUND)
