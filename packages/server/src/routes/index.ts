...
router.use('/agentflows', chatflowsRouter)
...
router.get('/document-store', (req, res, next) => {
    req.url = '/store'
    return documentStoreRouter(req, res, next)
})
router.get('/documentstore', (req, res, next) => {
    req.url = '/store'
    return documentStoreRouter(req, res, next)
})
