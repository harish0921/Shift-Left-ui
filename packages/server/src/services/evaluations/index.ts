...
const runAgain = async (id: string, baseURL: string, orgId: string, workspaceId: string) => {
    try {
        ...
        throw new internalShiftLiftError(StatusCodes.INTERNAL_SERVER_ERROR, `Error: EvalsService.runAgain - ${getErrorMessage(error)}`)
    }
}
...
const isOutdated = async (id: string, workspaceId: string) => {
    try {
        ...
        throw new internalShiftLiftError(StatusCodes.INTERNAL_SERVER_ERROR, `Error: EvalsService.isOutdated - ${getErrorMessage(error)}`)
    }
}
...
const getEvaluation = async (id: string, workspaceId: string) => {
    try {
        ...
        throw new internalShiftLiftError(StatusCodes.INTERNAL_SERVER_ERROR, `Error: EvalsService.getEvaluation - ${getErrorMessage(error)}`)
    }
}
