...
import { generateAgentflowv2 as generateAgentflowv2_json } from 'shiftleftai-components'
...
const generateAgentflowv2 = async (question: string, selectedChatModel: Record<string, any>) => {
    try {
        ...
        throw new internalShiftLiftError(StatusCodes.INTERNAL_SERVER_ERROR, `Error: generateAgentflowv2 - ${getErrorMessage(error)}`)
    }
}
